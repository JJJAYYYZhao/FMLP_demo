...
def main():
    ...
    parser.add_argument('--data_dir', default='D:/files/PythonProject/diginetica/', type=str)
    parser.add_argument('--data_name', default='diginetica', type=str)
    ...
    args.data_file = args.data_dir + args.data_name + '.train.inter'
    args.data_file_eval = args.data_dir + args.data_name + '.valid.inter'
    args.data_file_test = args.data_dir + args.data_name + '.test.inter'
